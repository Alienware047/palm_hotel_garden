...
export function RoomCard({
  ...
  return (
    <motion.div
      ...
      className="group glass no-hover rounded-2xl border border-glass-border overflow-hidden flex flex-col h-full"
    >
      {/* Image */}
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mt-auto">
          ...
          <Link href={`/rooms/${slug}`}>
            <motion.div
              whileTap={{ scale: 0.95 }}
              className="glass no-hover text-center py-2.5 rounded-xl border border-primary text-primary font-semibold tracking-wide transition-all duration-300 hover:bg-secondary hover:text-white hover:border-secondary"
            >
              Book Now
            </motion.div>
          </Link>
